...
<html>
	...
	if(($name == NULL or $quantity ==NULL) or ($name == NULL and $quantity ==NULL))
	{
		echo ("Παρακαλώ εισάγετε όνομα και ποσότητα!");
	}
	else
	{
		echo ("Έχετε εισάγει το Υλικό: <b>".$name."</b> με Μονάδα μέτρησης: <b>");
		if($measurementunit == 0) //measurementunit έχει τιμές 0 = Τεμάχια, 1 = Γραμμάρια
		{
			echo "Τεμάχια</b>";
		}
		else
	...
	//εισαγωγή των μεταβλητών στον πίνακα materials
	?>
