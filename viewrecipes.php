...
<html>
	...
	echo ("<h1 id='par2'>Παρακαλώ επιλέξτε μια συνταγή</h1><ul id='list2'>");	
	$key=0;
	$key=mysql_query("SELECT * FROM recipes order by recipeTime ASC"); //εμφανίζει όλα τα στοιχεία του πίνακα ταξινομημένα κατά τον χρόνο εκτέλεσης
