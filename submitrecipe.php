...
<html>
	...
	$recipeName=$_POST['inputrecipename']; //Παίρνει το inputrecipename μέσω της post και το καταχωρει στην μεταβλητή $recipeName
	$recipeCategory=$_POST['recipeCategory'];
	$recipeTime=$_POST['recipeTime'];
	$quantity1=$_POST['inputquantity1']; //Παίρνει το inputquantity1 μέσω της post και το καταχωρει στην μεταβλητή $quantity1
	$material1=$_POST['inputmaterial1']; //Παίρνει το inputmaterial1 μέσω της post και το καταχωρει στην μεταβλητή $material1
